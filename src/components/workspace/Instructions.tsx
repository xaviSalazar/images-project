            ...
            <CarouselItem key={item}>
              <div className="flex flex-col w-full justify-center">
                ...
                <div className="flex flex-grow w-full justify-center">
                  {tabToVideoIndex[item] !== undefined &&
                    renderInstructions(tabToVideoIndex[item])}
                </div>
              </div>
            </CarouselItem>
          ))}
  ...
  return (
    <>
      ...
      <Dialog open={open} onOpenChange={onOpenChange}>
        ...
        <DialogContent className="w-full max-w-md h-[500px] sm:max-w-xl sm:h-[700px] md:max-w-7xl md:h-[800px]">
          <DialogTitle>
            Instructions (swipe or click next for more){" "}
          </DialogTitle>
          {CarouselDemo()}
        </DialogContent>
      </Dialog>
